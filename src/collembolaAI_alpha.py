...
class collembola_ai:
    ...
    def __init__(self, workingdir = config['DEFAULT']['working_directory'], outputdir = config['OPTIONAL']['output_directorty'], n_iterations = config['OPTIONAL']['iterations'], work_num = config['OPTIONAL']['number_of_workers'], my_batch_size = config['OPTIONAL']['batch_size'], learning_rate = config['OPTIONAL']['learning_rate'], number_classes = config['OPTIONAL']['number_of_classes'], treshhold = config['OPTIONAL']['detection_treshhold']):
